...
const Explore = () => {
    return (
        <section className='bg-linear-to-r from-[#4f39f6] to-[#9514fa]  py-25'>
            <div className='container mx-auto text-white text-center px-3 sm:px-0'>
                <div className='space-y-4'>
                    ...
                    <div className='space-x-4 mt-10'>
                        ...
                        <button className='btn rounded-full border border-white text-white btn-ghost hover:text-black transition-all duration-150 font-semibold'>View Pricing</button>
                    </div>
